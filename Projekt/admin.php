...
<div class="container-fluid" id="container">
  <div class="row">
    ...
    box-shadow: 1px 1px 50px 5px #222831;">
      <h1 class="h11">Wszyscy użytkownicy:</h1>
      <form action="scripts/formsub.php" method="post">
    ...
    color: #eeeeee;
    box-shadow: 1px 1px 50px 5px #222831;">
      <h1 class="h11">Baza słówek</h1>
      <form action="scripts/formsub.php" method="post">
        <ul style="list-style-type: none;">
        <?php
          include("./scripts/wordsalter.php");
         ?>
         <br><input type='text' name='neweng' class='text' placeholder='New english'>
         <input type='text' name='newpol' class='text' placeholder='New polish'>
       </ul>
